...
public class RemovingState : IBuildingState
{
    ...
    public void OnAction(Vector3Int gridPosition)
    {
        ...
        else
        {
            ...
            // Aquí debes pasar el índice en lugar del GameObject
            objectPlacer.RemoveObjectAt(gameObjectIndex);

            // Obtén el prefab del objeto desde la base de datos
            GameObject prefab = database.objectsData[gameObjectIndex].Prefab;
        }
